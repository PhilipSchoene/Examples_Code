...
if os.path.exists(os.path.join(dejavu_root, "DejaVuSans.ttf")):
    ...
    pdfmetrics.registerFont(TTFont("DejaVuOb", os.path.join(dejavu_root, "DejaVuSansMono.ttf")))
    ...
    pdfmetrics.registerFont(TTFont("DejaVuBdOb", os.path.join(dejavu_root, "DejaVuSansMono-Bold.ttf")))
