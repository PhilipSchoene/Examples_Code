...
from institute.models.physical_processes import Substrate, HallMeasurement, RamanMeasurement, FTIRMeasurement, LPSMeasurement, PLMeasurement
#PDSMeasurement SolarsimulatorMeasurement, SolarsimulatorCellMeasurement, Structuring
from institute.models import SampleDetails
#, \ InformalLayer
...
admin.site.register(RamanMeasurement)
admin.site.register(FTIRMeasurement)
admin.site.register(LPSMeasurement)
admin.site.register(PLMeasurement)
